...
--
-- Host: localhost:3306
-- Generation Time: Aug 08, 2021 at 01:47 AM
...
(34, '103.152.147.52', 'admin@hms.com', 1628320453);
...
INSERT INTO `serial` (`id`, `serial_no`, `x`) VALUES
(1, 1, NULL),
(2, 2, NULL),
(3, 3, NULL),
(4, 4, NULL),
...
(1, 'Doctor Care', 'Doctor Clinic', 'Boropool, Rajbari-7700', '+0123456789', 'admin@demo.com', '#', '$', 'english', 'flat', 'jitsi', 'percentage', 'Login Title', 'uploads/logo-nonetext1.png', '', 'PayPal', 'Twilio', '', '', 'Asia/Dhaka', 'Domain Email', '', '', '', '');
...
(2, 'Best Clinic Management System', 'uploads/1707260345350542.jpg', 'Best Clinic management System', 'Best Clinic management System', 'Best Clinic management System', '1', 'Inactive');
...
(1, '127.0.0.1', 'admin', '$2y$08$dxACPpnFozxfaNdOyKR8x.R4SwJwru2rFwG6BBfOpUnAoVfViQDs.', '', 'admin@dms.com', '', 'g0wt205VJVb4a9819f14ce3d10dffe14f93680e2', 1607595309, 'zCeJpcj78CKqJ4sVxVbxcO', 1268889823, 1628398796, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `patient_deposit`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1759;
...
--
ALTER TABLE `time_slot`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2543;

--
-- AUTO_INCREMENT for table `users`
--
ALTER TABLE `users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1588;

--
-- AUTO_INCREMENT for table `users_groups`
--
ALTER TABLE `users_groups`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5585;
